...
public class InstagramConstants {
    ...
    public static String apiKey = "012a54f51c49aa8c5c322416ab1410909add32c966bbaa0fe3dc58ac43fd7ede";
    public static String apiKeyVersion = "4";
    public static String deviceManufacturer = "Xiaomi";
    public static String deviceModel = "HM 1SW";
    public static String deviceAndroidVersion = "18";
    public static String deviceAndroidRelease = "4.3";
    public static String userAgent = String.format("Instagram 9.2.0 Android (%s/%s; 320dpi; 720x1280; %s; %s; armani; qcom; en_US)",
        deviceAndroidVersion, deviceAndroidRelease, deviceManufacturer, deviceModel);
